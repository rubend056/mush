...
release) and the wrap itself (`R32`: the tab stop and break loop are two
spellings, pinned by one parity test over twelve texts at widths 1..=24 and a
ten-character fuzz at widths 1..=12). The mark's drop rule
